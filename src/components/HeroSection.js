...
import { ArrowRight, Sparkles, ExternalLink, Play, ChevronRight, Globe, Shield, Zap } from 'lucide-react';
...
const StatCard = ({ label, value, index }) => (
  ...
  >
    ...
    <div className="relative p-4 bg-gray-800/50 backdrop-blur-xl rounded-xl border border-orange-500/20">
...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen pt-20 lg:pt-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-800/50 backdrop-blur-xl border border-orange-500/20 mb-6"
            >
              <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse" />
              <span className="text-gray-300 text-sm">Platform Status: Operational</span>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-2 justify-center lg:justify-start mb-4">
                <div className="px-4 py-1 bg-orange-500/10 rounded-full border border-orange-500/20 text-orange-400 text-sm flex items-center gap-2">
...
>
  {Array.from({ length: 48 }).map((_, i) => (
    <div
      ...
      style={{
        transform: `rotate(${i * 7.5}deg) translateX(280px) translate(-50%, -50%)`
      }}
    />
  ))}
</motion.div>
              ...
              <FloatingElement
                delay={0}
                className="absolute top-20 left-20 w-48 h-32 bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-orange-500/20 p-4 flex flex-col justify-between"
              >
              ...
              <FloatingElement
                delay={1}
                className="absolute bottom-20 right-20 w-48 h-32 bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-orange-500/20 p-4 flex flex-col justify-between "
              >
                <ExternalLink size={24} className="text-orange-500 z-50"  />
                <div className="text-xl text-orange-500 flex items-center">
                  <TypeWriter words={typingWords} />
                  <span className='text-xl text-orange-500 z-50'>test 1</span>
                </div>
              </FloatingElement>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <motion.div
                  ...
                  className="w-32 h-32 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center relative"
                >
