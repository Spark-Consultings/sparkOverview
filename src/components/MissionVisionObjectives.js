...
const Card = ({ icon: Icon, title, description, delay }) => (
  <motion.div
    ...
    className="bg-white/5 backdrop-blur-xl rounded-xl border border-white/10 p-6 relative group"
  >
    <motion.div
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className="text-[#FF7452] font-medium">Notre essence</span>
      </motion.div>
...
numérique, en les guidant sur un chemin fluide vers un monde connecté, innovant et durable."
      ...
      <Card
        icon={Flag}
        title="Objectifs"
        description="Devenir le moteur qui alimente l'innovation numérique de nos clients. Chez SPARKline, nous
traçons une route claire vers la réussite en transformant des idées ambitieuses en solutions
